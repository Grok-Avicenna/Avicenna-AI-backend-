    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_card_photo', models.ImageField(upload_to='Passports/', verbose_name="Passport's photo")),
                ...
                ('verify_time', models.DateField(default=django.utils.timezone.now, verbose_name='Verify time')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated at')),
                ('user_type', models.CharField(choices=[('doctor', 'Doctor'), ('patient', 'Patient')], max_length=10, verbose_name="User's type")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('experience', models.CharField(max_length=5, null=True, verbose_name='Experience')),
                ('work_time_start', models.TimeField(verbose_name='Start of working')),
                ('end_time_start', models.TimeField(verbose_name='End of working')),
                ('schedule', models.CharField(max_length=255, verbose_name='Schedule')),
                ('educations', models.FileField(upload_to='diplomas/', verbose_name='Files of cerificates')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('age', models.CharField(choices=[('child', 'Child'), ('adult', 'Adult'), ('pensioner', 'Pensioner'), ('disabled', 'Disabled')], max_length=10, verbose_name='Age of patient')),
